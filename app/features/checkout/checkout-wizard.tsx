...
import { Check, Plus, Minus, Trash2, ShoppingCart, ChevronRight, ChevronLeft, Lock } from "lucide-react";
...
export function CheckoutWizard({ onBack }: CheckoutWizardProps) {
  ...
  const isStepCompleted = (stepId: string): boolean => {
    switch (stepId) {
      ...
      case "personal-info":
        return completedSteps.includes("personal-info") || Boolean(
  ...
  const handleComplete = () => {
    ...
    const whatsappMessage = generateWhatsAppMessage(billingInfo, cartItems, totalPrice);
